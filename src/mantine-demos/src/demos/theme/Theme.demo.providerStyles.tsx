...
import { MantineProvider, Button, Badge, Group, ButtonStylesParams, rem } from '@reactgets/core';

const code = `
import { MantineProvider, Group, Button, Badge, ButtonStylesParams } from '@reactgets/core';
