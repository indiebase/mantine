...
import { TextInput, MultiSelect, NumberInput, MantineProvider, Box } from '@reactgets/core';

const code = `
import { TextInput, MultiSelect, NumberInput, MantineProvider } from '@reactgets/core';
