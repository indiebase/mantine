...
import { useUncontrolled, useMergedRef, useDidUpdate, useScrollIntoView } from '@reactgets/hooks';
import { DefaultProps, MantineSize, MantineShadow, getDefaultZIndex } from '@reactgets/styles';
...
Select.displayName = '@reactgets/core/Select';
