...
import: "import { ModalsProvider } from '@reactgets/modals';"
source: 'mantine-modals/src'
docs: 'others/modals.mdx'
installation: '@reactgets/modals'
license: MIT
---

import { ModalsDemos } from '@reactgets/demos';

## Installation

Package depends on `@reactgets/core` and `@reactgets/hooks`.

Install with yarn:

```bash
yarn add @reactgets/modals
```

Install with npm:

```bash
npm install @reactgets/modals
```
...
import { ModalsProvider } from '@reactgets/modals';
...
@reactgets/modals package includes special modal that can be used for confirmations.
...
```tsx
import { ContextModalProps, ModalsProvider } from '@reactgets/modals';
import { Text, Button } from '@reactgets/core';
...
declare module '@reactgets/modals' {
...
```tsx
import { openContextModal, closeModal } from '@reactgets/modals';
openContextModal({
  modal: 'demonstration',
