...
installation: '@reactgets/notifications'
license: MIT
---

import { NotificationDemos, NotificationsDemos } from '@reactgets/demos';
...
```bash
yarn add @reactgets/notifications
```

Install with npm:

```bash
npm install @reactgets/notifications
```
...
`@reactgets/notifications` package exports the following functions:
...
All functions can be imported from `@reactgets/notifications` package and can be used in any part of your application:
