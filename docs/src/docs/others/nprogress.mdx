...
import: "import { NavigationProgress } from '@reactgets/nprogress';"
source: 'mantine-nprogress/src'
docs: 'others/nprogress.mdx'
installation: '@reactgets/nprogress'
license: MIT
---

import { NProgressDemos } from '@reactgets/demos';
...
```bash
yarn add @reactgets/nprogress
```

Install with npm:

```bash
npm install @reactgets/nprogress
```
...
import { NavigationProgress } from '@reactgets/nprogress';
...
import { NavigationProgress, nprogress } from '@reactgets/nprogress';
