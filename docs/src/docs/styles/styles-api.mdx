...
import { Slider as SliderStylesApi, Button as ButtonStylesApi } from '@reactgets/styles-api';
...
```tsx
import { Slider, createStyles, rem } from '@reactgets/core';
...
```tsx
import { MantineProvider, Text } from '@reactgets/core';
