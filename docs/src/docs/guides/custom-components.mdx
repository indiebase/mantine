...
import { createStyles, MantineNumberSize } from '@reactgets/core';
...
```tsx
// MyComponent.tsx
import { DefaultProps, Selectors, MantineNumberSize, Box } from '@reactgets/core';
...
```tsx
import { DefaultProps } from '@reactgets/core';
