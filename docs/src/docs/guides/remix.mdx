...
<PackagesInstallation extraPackages={['@reactgets/remix', '@emotion/server']} />
...
import { injectStyles, createStylesServer } from '@reactgets/remix';
...
import { MantineProvider, createEmotionCache } from '@reactgets/core';
import { StylesPlaceholder } from '@reactgets/remix';
...
import { ClientProvider } from '@reactgets/remix';
