...
import: "import { useFocusTrap } from '@reactgets/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'mantine-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@reactgets/demos';
...
```tsx
import { useFocusTrap } from '@reactgets/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@reactgets/hooks';
