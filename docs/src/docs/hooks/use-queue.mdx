...
import: "import { useQueue } from '@reactgets/hooks';"
docs: 'hooks/use-queue.mdx'
source: 'mantine-hooks/src/use-queue/use-queue.ts'
---

import { NotificationsDemos } from '@reactgets/demos';

## Usage

use-queue limits the amount of data in current state and places the rest of it in a queue.
For example, in [@reactgets/notifications](/others/notifications/) package amount of
...
```tsx
import { useQueue } from '@reactgets/hooks';
