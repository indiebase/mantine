...
import { ThemeDemos } from '@reactgets/demos';
...
```tsx
import { MantineThemeOverride, MantineProvider } from '@reactgets/core';
...
You can import `MantineTheme` type from `@reactgets/core` package:

```tsx
import { useMantineTheme, MantineTheme } from '@reactgets/core';
