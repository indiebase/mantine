...
props: ['Notification']
import: "import { Notification } from '@reactgets/core';"
source: 'mantine-core/src/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@reactgets/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@reactgets/notifications](/others/notifications/) package.
