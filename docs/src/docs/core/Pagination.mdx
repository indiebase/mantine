...
import: "import { Pagination } from '@reactgets/core';"
source: 'mantine-core/src/Pagination/Pagination.tsx'
docs: 'core/Pagination.mdx'
styles: ['Pagination']
---

import { PaginationDemos } from '@reactgets/demos';
...
If you need more flexibility @reactgets/hooks exports [use-pagination](/hooks/use-pagination/) hook,
