...
import: "import { useForm } from '@reactgets/form';"
...
`@reactgets/form` package does not depend on any other libraries, you can use it with or without `@reactgets/core` inputs:
...
import { useForm, UseFormReturnType } from '@reactgets/form';
