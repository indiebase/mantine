...
props: ['MonthPicker']
import: "import { MonthPicker } from '@reactgets/dates';"
source: 'mantine-dates/src/components/MonthPicker/MonthPicker.tsx'
docs: 'dates/MonthPicker.mdx'
styles: ['MonthPicker']
---

import { MonthPickerDemos } from '@reactgets/demos';
...
Usually it is better to specify `@reactgets/dates` package locale in [DatesProvider](/dates/dates-provider/),
