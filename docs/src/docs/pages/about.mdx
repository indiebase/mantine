...
import { MantineLogoDemos } from '@reactgets/demos';
...
All `@reactgets/*` packages follow [semver](https://semver.org/):
...
You can also install `@reactgets/ds` package and import `MantineLogo` component:

```bash
yarn add @reactgets/ds

npm install @reactgets/ds
```
