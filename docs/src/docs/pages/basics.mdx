...
import { SliderDemos, CreateStylesDemos } from '@reactgets/demos';
...
import { Button, Paper, TextInput } from '@reactgets/core';
...
`@reactgets/core` package export types to help you build components and styles with TypeScript:
